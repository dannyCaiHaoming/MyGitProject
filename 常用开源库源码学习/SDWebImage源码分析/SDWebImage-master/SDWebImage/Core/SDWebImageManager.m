...
/*
 备注：
 SDWebImage的image资源标识的key，默认是使用资源全地址
 1.如果是使用缩略图尺寸的话,使用{Thumbnail+width+height+比例}作为标识k
 2.如果是经历过转换的，使用转换+是否水平翻转+旋转角度
 */
...
- (SDWebImageCombinedOperation *)loadImageWithURL:(nullable NSURL *)url
    ...
    /*
     备注：
     SDWebImageCombinedOperation是整合了加载和缓存的Operation，且增加的cancel的接口
     */
